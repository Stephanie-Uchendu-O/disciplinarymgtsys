                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">MY ALLEGATION REPORTS</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $result = mysqli_query($conn, "select * from reports where mat_no='$userid'");
                                                $a = 1;
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="student-malpractice-report?r=<?php echo base64_encode($report_id); ?>" title="See Details"> <i class="ti-dropbox">DETAILS</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $a++;
