...
if (isset($_POST["add"])) {
    ...
    if ($sexhibit != "") {
        $insert_report = mysqli_query($conn, "insert into  reports values ('$rid','$sname','$smat_no','$sinvigilator_id','$sdept','$sfaculty','$scourse','$sphone','$semail','$sexhibit','$sicomment','$sstd_comment','$semc_findings','$semc_comment','$schairman_resolution','$schairman_comment','$status','$date')") or die(mysqli_error($conn));
        if ($insert_report) {
                                ...
                                <div class="box-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input readonly="" name="fullname" type="text" class="form-control" placeholder="Student Fullname"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly="" name="faculty" type="text" class="form-control" placeholder="Student Faculty"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Student Department</label>
                                            <input readonly="" name="dept" type="text" class="form-control" placeholder="Student Department"/>
                                        </div>


                                        <div class="form-group">
                                            <label>Course</label>
                                            <input readonly="" name="course" type="text" class="form-control" placeholder="Malpractice Course"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input readonly="" name="phone" type="text" class="form-control" placeholder="Student Phone"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input readonly="" name="email" type="email" class="form-control" placeholder="Student Email"/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Comment</label>
                                            <textarea readonly="" name="comment" class="form-control" rows="3" placeholder="Enter comment on exhibit"></textarea>
                                        </div>
