...
if (isset($_POST["add"])) {
    $student_reponse = $_POST["comment"];
    $update_report = mysqli_query($conn, "update reports set std_comment='$student_reponse' where rid='$repid'") or die(mysqli_error($conn));
    if ($update_report) {
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Respond to Allegation</h3>
                                    ...
                                    if ($student_comment == "") {
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>Comment</label>
                                                <textarea name="comment" class="form-control" rows="3" placeholder="Respond to allegation"></textarea>
                                            </div>
