                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title br-0">Welcome <?php echo "MATRICULATION NUMBER ---- ".$userid; ?></h3>
                            </div>
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <div class="d-flex justify-content-between mb-5">
                                            <div>
                                                <span class="d-block text-dark font-weight-500">My Misconduct Report</span>
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            <?php
                                            $num_feed_backs = mysqli_num_rows(mysqli_query($conn, "select * from reports where mat_no='$userid'"));
                                            ?>
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        <div class="d-flex justify-content-between mb-5">
                                            ...
                                            <?php
                                            $num_members = mysqli_num_rows(mysqli_query($conn, "select * from reports where mat_no='$userid' and status='YES'"));
                                            ?>
                                            <div>
